...
describe('#humanYearsCatYearsDogYears', () => {
  ...
  it('dogs and cats years for ten human years', () => { assert.deepStrictEqual(humanYearsCatYearsDogYears(1), [1, 15, 15]); });
  it('dogs and cats years for two human years', () => { assert.deepStrictEqual(humanYearsCatYearsDogYears(2), [2, 24, 24]); });
  it('dogs and cats years for ten human years', () => { assert.deepStrictEqual(humanYearsCatYearsDogYears(10), [10, 56, 64]); });
});
